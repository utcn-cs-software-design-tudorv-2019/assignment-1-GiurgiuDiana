...
public class TeacherProfile {
    JFrame frm=new JFrame("Teacher Profile");
        ...
        updateProfile.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent arg0) {
                ...
                else
                {
                    ...
                    {
                        int success=new TeacherBll().updateTeacher(1, "name", newName.getText());
                        if (success==1)
                        {
                    ...
                    {
                        int success=new TeacherBll().updateTeacher(1, "password", newPass.getText());
                        if (success==1)
                        {
                            JOptionPane.showMessageDialog(null,"Operatie executata cu succes");
                        }
                    ...
                    {
                        int success= new TeacherBll().updateTeacher(id, "address", newAdress.getText());
                        if (success==1)
                        {
                            JOptionPane.showMessageDialog(null,"Operatie executata cu succes");
                        }
                    ...
                    {
                        int st= new TeacherBll().updateTeacher(id, "email", newEmail.getText());
                        if (st==1)
                        {
                            JOptionPane.showMessageDialog(null,"Operatie executata cu succes");
                        }
                    ...
                    {
                        int st= new TeacherBll().updateTeacher(id, "age", newAge.getText());
                        if (st==1)
                        {
                            JOptionPane.showMessageDialog(null,"Operatie executata cu succes");
                        }
